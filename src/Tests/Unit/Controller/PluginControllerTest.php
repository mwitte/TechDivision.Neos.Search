...
class PluginControllerTest extends \TYPO3\Flow\Tests\UnitTestCase {
	...
	/**
	 * @var \Com\TechDivision\Neos\Search\Controller\PluginController
	 */
	protected $pluginController;

	public function setUp(){
		parent::setUp();
		$this->pluginController = new \Com\TechDivision\Neos\Search\Controller\PluginController();
	}
	...
	public function testSearchAction(){
		$viewMock = $this->getMockBuilder('\TYPO3\Flow\Mvc\View\ViewInterface', array())->disableOriginalConstructor()->getMock();
		$this->inject($this->pluginController, 'view', $viewMock);
		$searchProvider = $this->getMock('\Com\TechDivision\Neos\Search\Provider\SearchProvider', array('search'));
		...
		$this->assertSame(null, $this->pluginController->searchAction(new \Com\TechDivision\Neos\Search\Domain\Model\Request()));
	}
}
?>